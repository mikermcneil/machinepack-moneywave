module.exports = {
  ...
  friendlyName: 'Fund sub-wallet (charging debit card via 3D Secure)',
  ...
  inputs: {
    ...
    senderCardToken: {
      description: 'The tokenized card string for the sender\'s debit card.',
      example: '',
      required: true
    },
  ...
  fn: async function(inputs, exits) {
    ...
    var resInfo = await HTTP.sendHttpRequest({
      ...
      body:
      {
        ...
        card_token: inputs.senderCardToken,// eslint-disable-line camelcase
        recipient: 'wallet',
